...
collapsed.selectAll("g").append("rect").attr("x", 0).attr("y", 0).attr("rx", "0").attr("ry", "0").attr("width", "180").attr("height", "120").attr("stroke", "#e0e2e5").attr("stroke-width", "1");
collapsed.selectAll("g").append("text").attr("fill", "blue").attr("x", "7").attr("y", "112").attr("font-size", "15px").text("Explore")
...
content.selectAll("g").append("rect").attr("x", 0).attr("y", 0).attr("rx", "0").attr("ry", "0").attr("width", "180").attr("height", "248").attr("stroke", "#e0e2e5").attr("stroke-width", "1");
...
function renderPart(Qarray, xcount, ycount) {
    ...
    for (i = 0; i < Qarray.length; i++) {
        ...
        y[index] = ycount;
        if (i == 0) {
            collapsed.select("g[id='" + index + "']").append("path").attr("class", "connector").attr("transform", "translate(-20,0)").attr("fill", "#e0e2e5").attr("d", arc);
            collapsed.select("g[id='" + index + "']").append("rect").attr("class", "connector").attr("x", -21).attr("y", 15).attr("width", 21).attr("height", 5).attr("fill", "#e0e2e5");
        } else {
            if (xcount == 130) {
        ...
        if (xcount + 248 < canvaswidth -248) {
            ...
            if (i < Qarray.length -1) {
                collapsed.select("g[id='" + index + "']").append("rect").attr("class", "connector").attr("x", 180).attr("y", 15).attr("width", 20).attr("height", 5).attr("fill", "#e0e2e5")
            };
        } else {
            xcount = 130;
            if (i < Qarray.length -1) {

...
function renderPart(Qarray, xcount, ycount) {
    ...
    for (i = 0; i < Qarray.length; i++) {
        ...
        if (i == 0) {
            ...
            collapsed.select("g[id='" + index + "']").append("svg").attr("x", -40).attr("y", "0").attr("width","45").attr("height","30").append("path").attr("d","M 0 0 L 15 15 L 40 15").attr("stroke","black").attr("stroke-width","1").attr("fill", "none");
            ...
            if (xcount == 130) {
			 ...
			 if (xcount == 130) {
            collapsed.select("g[id='" + index + "']").append("svg").attr("x", -40).attr("y", "-20").attr("width","600").attr("height","30").append("path").attr("d","M 40 0 L 2000 0").attr("stroke","black").attr("stroke-width","2").attr("fill", "none");
            }
			if (xcount == 130) {
            collapsed.select("g[id='" + index + "']").append("path").attr("class", "connector").attr("transform", "translate(560,-39)").attr("fill", "#000").attr("d", arccontrev);
            }
        };
        if (xcount + 200 < canvaswidth -200) {
            ...
            if (i < Qarray.length -1) {
                ycount = ycount + 220;
                collapsed.select("g[id='" + index + "']").append("rect").attr("class", "connector").attr("x", "250").attr("y", "15").attr("width", "170 !important").attr("height", "1").attr("fill", "#000");
            };
        };
